...
class Hotwheels extends StatefulWidget {
  const Hotwheels({Key key}) : super(key: key);

  @override
  State<Hotwheels> createState() => _Hotwheels();
}

class _Hotwheels extends State<Hotwheels> {
  // future setting
    ...
    return PagewiseGridView<ProductModel>.count(
      ...
      pageFuture: (pageIndex) {
        return ProductService.getProductsByCategoryId(
            pageIndex, PAGE_SIZE, "عجلة الساخنة");
      },
    );
  }
  ...
  Widget _itemBuilder(context, ProductModel entry, _) {
    return InkWell(
      hoverColor: const Color(0xff017bbd),
      onTap: () {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xff017bbd),
      appBar: CustomAppBar(
        leadingAction: () {
                ...
                children: [
                  Container(
                    padding: EdgeInsets.only(
                        ...
                        bottom: 0),
                    child: Text(
                      AppLocalizations.of(context).hotwheels_hotwheels,
                      style: const TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                        fontSize: 32,
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      AppLocalizations.of(context).hotwheels_collection,
                      style: const TextStyle(
                        color: Colors.white,
