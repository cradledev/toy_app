...
class Marvel extends StatefulWidget {
  ...
  @override
  State<Marvel> createState() => _Marvel();
}
...
class _Marvel extends State<Marvel> {
  ...
  void initState() {
    super.initState();
    products = _productService.getManufacture('Marvel');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xffdb4141),
                ...
                children: [
                  Container(
                    padding: EdgeInsets.only(
                        ...
                        bottom: 0),
                    child: Text(
                      AppLocalizations.of(context)!.marvelpage_marvel,
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!.marvelpage_collection,
                      style: const TextStyle(
                        color: Colors.white,
