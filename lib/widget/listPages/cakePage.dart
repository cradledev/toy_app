...
class _Cake extends State<Cake> {
  ...
  void initState() {
    super.initState();
    products = _productService.getCategory('Cake');
  }
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!.cakepage_cakes,
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!.cakepage_collection,
                      style: const TextStyle(
                        color: Colors.black,
