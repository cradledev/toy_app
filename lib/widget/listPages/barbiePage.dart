...
class Barbie extends StatefulWidget {
  const Barbie({Key? key}) : super(key: key);

  @override
  State<Barbie> createState() => _Barbie();
}

class _Barbie extends State<Barbie> {
  int currentIndex = 0;
  ...
  void initState() {
    super.initState();
    products = _productService.getManufacture('Barbie');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xffe44f9c),
                ...
                children: [
                  Container(
                    padding: EdgeInsets.only(
                        ...
                        bottom: 0),
                    child: Text(
                      AppLocalizations.of(context)!.barbiepage_barbie,
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!.barbiepage_collection,
                      style: const TextStyle(
                        color: Colors.white,
