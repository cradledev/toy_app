...
class Robots extends StatefulWidget {
  ...
  @override
  State<Robots> createState() => _Robots();
}

class _Robots extends State<Robots> {
  ...
  void initState() {
    super.initState();
    products = _productService.getCategory('Robots');
  }
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!.robotspage_robots,
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!.robotspage_collection,
                      style: const TextStyle(
                        color: Colors.black,
