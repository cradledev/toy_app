...
class Party extends StatefulWidget {
  ...
  @override
  State<Party> createState() => _Party();
}
...
class _Party extends State<Party> {
  ...
  void initState() {
    super.initState();
    products = _productService.getCategory('Party Supplies');
  }
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Text(
                    AppLocalizations.of(context)!.partypage_party,
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Text(
                    AppLocalizations.of(context)!.partypage_collection,
                    style: const TextStyle(
